...
# make sure to restart R after installing magrittr
# `#.Samples': for each sequence, how many samples it is in / abundance??
ft %>% head(10)
```
...
The common species are at the other end of the frequency count table: the most common species was observed 3453 times. There was only one species observed 3453 times.
...
*Note: At time of writing (August 2019), `breakaway`, with the default settings, produced an estimate of 7724. If this number has changed significantly since then, it's because we are constantly making improvements to the code base, which may change estimates -- usually by a little but sometimes by more. Please let me know or [log an issue](https://github.com/adw96/breakaway/issues) to let us know if this occured!*
